...
export const buildCopilotPrompt = (event, session, speaker, userQuestion) => {
...
2. Be immediately actionable (e.g. give an exact icebreaker question, a pronunciation phonetic, or a 1-sentence fun fact about the speaker).
